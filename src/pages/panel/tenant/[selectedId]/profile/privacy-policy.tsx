...
import { PanelAccountLayout, TenantLayout } from "layouts";

const PrivacyPolicy = () => {
  return (
    <TenantLayout title="Privacy Policy">
            ...
            <div className="w-full text-themeDarkGray flex flex-col gap-4">
              <div className="flex flex-col gap-1">
                ...
                <p className="">
                  ...
                  that is collected and recorded by skyrise and how we use it.
                </p>
              ...
              <div className="flex flex-col gap-1">
                ...
                <p>
                  ...
                  of the advertising partners of skyrise.
                </p>
                ...
                <p>
                  Note that skyrise has no access to or control over these
              ...
              <div className="flex flex-col gap-1">
                ...
                <p>
                  skyrise's Privacy Policy does not apply to other advertisers
...
export default WithProtectedTenant(PrivacyPolicy);
