import { AddPricingDetails } from "components/admin/common";
...
const pricing = () => {
  return (
    <TenantLayout title="Property Pricing" headerText={"Property Pricing"}>
...
export default withProtectedLandlord(pricing);
