import { AddPropertiesPhoto } from "components/admin/properties";
...
const PropertyPhotos = () => {
  return (
    <TenantLayout title="Property Photo" headerText={"Photos & Videos"}>
...
export default withProtectedLandlord(PropertyPhotos);
