...
import { AddPropertyForm } from "components/admin/PropertyForm.tsx";
...
const LocationDetails = () => {
  return (
    <TenantLayout
      title="Property Location | SKYRISE"
      headerText={`Property Location`}
    >
...
export default withProtectedLandlord(LocationDetails);
