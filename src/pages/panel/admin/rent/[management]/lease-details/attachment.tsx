import { AttachmentDetails, RulesDetails } from "components/admin/LeaseBasic";
...
const Attachment = () => {
  ...
  return (
    <TenantLayout title="Attachment" headerText={propertyName?.data?.data}>
      <div className="w-full py-5 md:py-10 px-3 md:bg-gradient-to-br text-themeDarkGray from-themeGray/10 to-white md:px-5 !min-h-[calc(100vh-4.5rem) ">
        <StepperLayout menuItems={activeUserArr}>
          <div className="w-full flex flex-col bg-white md:p-6 rounded-lg  h-full">
...
export default withProtectedLandlord(withProtectedSubscription(Attachment));
