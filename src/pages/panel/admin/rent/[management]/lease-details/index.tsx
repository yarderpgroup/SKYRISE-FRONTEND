import { LeaseTerm } from "components/admin/LeaseBasic";
...
const AddProperty = () => {
  ...
  return (
    <TenantLayout title="Lease Term" headerText={propertyName?.data?.data}>
        ...
        <StepperLayout menuItems={activeUserArr}>
          <div className="w-full flex flex-col bg-white md:p-6 rounded-lg md:shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px] h-full">
            <div className="w-full flex flex-col gap-3 md:gap-5">
              <LeaseTerm setTenantId={setTenantId} tenantId={tenantId} />
            </div>
          </div>
        </StepperLayout>
      </div>
...
export default withProtectedLandlord(withProtectedSubscription(AddProperty));
