...
import { LeaserInfo } from "components/admin/rentProperty";
...
const Rules = () => {
  ...
  return (
    <TenantLayout title="Lessor Info" headerText={propertyName?.data?.data}>
      <div className="w-full py-5 md:py-10 px-3 md:px-5 !min-h-[calc(100vh-4.5rem) ">
        <StepperLayout menuItems={activeUserArr}>
          <div className="w-full flex flex-col md:p-6 rounded-lg h-full">
