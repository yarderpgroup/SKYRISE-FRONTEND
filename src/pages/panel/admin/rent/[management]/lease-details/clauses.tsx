import { Clauses } from "components/admin/LeaseBasic";
...
const ClausesDetails = () => {
  ...
  return (
    <TenantLayout title="Clauses" headerText={propertyName?.data?.data}>
...
export default withProtectedLandlord(withProtectedSubscription(ClausesDetails));
