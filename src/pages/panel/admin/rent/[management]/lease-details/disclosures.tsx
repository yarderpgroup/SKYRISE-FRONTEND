import { Disclosures, RulesDetails } from "components/admin/LeaseBasic";
...
const DisclosuresDetails = () => {
  ...
  return (
    <TenantLayout title="Disclosures" headerText={propertyName?.data?.data}>
      <div className="w-full  px-3 md:bg-gradient-to-br text-themeDarkGray from-themeGray/10 to-white md:px-5 !min-h-[calc(100vh-4.5rem) ">
        <StepperLayout menuItems={activeUserArr}>
          <div className="w-full flex flex-col md:p-6  h-full">
...
export default withProtectedLandlord(
  withProtectedSubscription(DisclosuresDetails)
);
