import { RentProfileDetails } from "components/admin/rentProperty";
...
const PropertyProfile = () => {
  return (
    <TenantLayout title="Property Profile" headerText={"Property Profile"}>
...
export default withProtectedLandlord(PropertyProfile);
