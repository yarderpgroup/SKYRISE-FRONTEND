...
import { WithProtectedTenant, withProtectedSuperAdmin } from "hooks";
...
const MyNotification = () => {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          const response = await remove({
            path: `notification/delete?notificationId=${row?._id}&type=ONE`,
            isAlert: true,
          });
          mutate();
        }
  ...
  return (
    <TenantLayout title="Notification | SKYRISE">
...
export default withProtectedSuperAdmin(MyNotification);
