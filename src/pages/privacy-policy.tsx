...
const PrivacyPolicy = () => {
  return (
    <PublicLayout title="Privacy Policy">
      <section className="w-full py-5 md:py-5 px-3 md:px-5 !text-themeDarkGray bg-white md:bg-gradient-to-b from-themeGray/10 to-white md:min-h-[calc(100vh-4.5rem)] relative flex items-center justify-center">
        <div className=" w-full h-full flex flex-col md:px-8 md:py-6 bg-white rounded-xl md:shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
          <div className="w-full text-themeDarkGray flex flex-col gap-4">
            <div className="flex flex-col gap-1">
              <h1 className="md:text-3xl text-2xl font-semibold">
                Privacy Policy for SKYRISE
              </h1>

              <p className="">
                At skyrise, accessible from https://realestate-sy.vercel.app,
                one of our main priorities is the privacy of our visitors. This
                Privacy Policy document contains types of information that is
                collected and recorded by skyrise and how we use it.
              </p>
              ...
              <p>
                ...
                information that they shared and/or collect in skyrise. This
            ...
            <div className="flex flex-col gap-1">
              ...
              <p>
                skyrise follows a standard procedure of using log files. These
            ...
            <div className="flex flex-col gap-1">
              ...
              <p>
                Like any other website, skyrise uses 'cookies'. These cookies
            ...
            <div className="flex flex-col gap-1">
              ...
              <p>
                ...
                the advertising partners of skyrise.
              </p>

              <p>
                Third-party ad servers or ad networks uses technologies like
                cookies, JavaScript, or Web Beacons that are used in their
                respective advertisements and links that appear on skyrise,
              ...
              <p>
                Note that skyrise has no access to or control over these cookies
            ...
            <div className="flex flex-col gap-1">
              ...
              <p>
                skyrise's Privacy Policy does not apply to other advertisers or
            ...
            <div className="flex flex-col gap-1">
              ...
              <p>
                skyrise does not knowingly collect any Personal Identifiable
