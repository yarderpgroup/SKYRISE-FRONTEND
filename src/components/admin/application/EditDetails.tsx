...
const EditInspectionDetails = ({ open, onClose, mutate, activeID }: Props) => {
  ...
  const issueSchema = [
    {
      ...
      placeHolder: "",
      initialValue: activeID?.inspectorName,
      type: "text",
    ...
    },
    {
      ...
      placeHolder: "",
      label: "StartTime",
      initialValue: dayjs(activeID?.startTime).format("hh:mm"),
      type: "time",
    ...
    },
    {
      ...
      placeHolder: "",
      label: "Date",
      initialValue: dayjs(activeID?.date).format("YYYY-MM-DD"),
      type: "date",
  ...
  return (
    ...
    >
      <div className="md:col-span-6 col-span-12 flex flex-col gap-6 p-6">
        <p className="font-semibold text-xl">Edit Inspection</p>
