...
import AddEditSchema from "schemas/AddEditSchema";
...
const FeesEditDrawer = ({ open, onClose, mutate }: Props) => {
  const handleSend = async (values: any) => {};
  const initialValues = AddEditSchema.reduce((accumulator, currentValue) => {
    accumulator[currentValue.name] = currentValue.initialValue;
    return accumulator;
  }, {} as any);
  const validationSchema = AddEditSchema?.reduce(
