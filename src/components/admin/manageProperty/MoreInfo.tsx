...
import { InformationDrawer } from "../drawer";
...
const MoreInfo = ({ open, onClose, mutate }: Props) => {
  ...
  return (
    <>
      <InformationDrawer open={openFees} onClose={() => setOpenFees(false)} />
            ...
            <div className=" py-2">
              ...
              <div className="flex flex-row gap-2 pt-5">
                ...
                <div className="flex flex-row gap-2">
                  ...
                  <h2 className=" text-themeDarkGray font-bold  flex items-center text-base"></h2>
                </div>
              </div>
              <div className="flex flex-row gap-2 pt-5">
                <div className="px-1 py-1 flex justify-center items-center bg-themeDarkGray text-white rounded-full">
