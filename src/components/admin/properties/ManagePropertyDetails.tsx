...
import { ManagePropertyBasicDetails } from ".";
import { AddPropertyForm } from "../PropertyForm.tsx";
import AddTenants from "./AddTenants";
const steps = ["Basic Details", "Location Details", "Add Tenants"];
  ...
  return (
    <div className="w-full py-5 ">
      ...
      <div className="w-full ">
        <Fragment>
          <div className="">
            {activeStep === 0 && <ManagePropertyBasicDetails />}
            {activeStep === 1 && <AddPropertyForm />}
            {activeStep === 2 && <AddTenants />}
            {/* {activeStep === 1 && <AddPropertyForm />}
