...
const EditMaintenanceView = ({ open, onClose, mutate, activeData }: Props) => {
  const issueSchema = [
    {
      key: 1,
      name: "locationType",
      label: "Location Type",
      placeHolder: "",
      initialValue: activeData?.locationType,
      type: "select",
      options: [
        {
          id: 1,
    ...
    },
    {
      ...
      initialValue: activeData?.issueLocation,
      type: "select",
      options: [
        {
          id: 1,
    ...
    },
    {
      ...
      placeHolder: "",
      label: "Category",
      initialValue: activeData?.category,
      type: "select",
      options: [
        {
          id: 1,
    ...
    },
    {
      ...
      initialValue: activeData?.problem,
      type: "select",
    ...
    },
    {
      ...
      initialValue: activeData?.priority,
      type: "select",
  ...
  const handleAddRequest = async (values: any, props: any) => {
    try {
      ...
      if (isImage) {
        formData.append(
          "maintenancePhoto",
          isImage || (activeData?.maintenancePhoto as any)
        );
      }
      formData.append("maintenanceId", activeData?._id);
      ...
      const response = await put({
        path: `maintenance/update/${propertyID}`,
        isAlert: true,
        isImage: true,
        body: formData,
      });
  ...
  return (
    ...
    >
      <div className="md:col-span-6 col-span-12 flex flex-col gap-6 p-6">
        <p className="font-semibold text-xl">Edit Maintenance</p>
        <div className="w-full flex flex-col gap-3">
          <p className=" leading-5">Edit Photo </p>
          <UploadImage
            defaultImage={activeData?.maintenancePhoto}
            className="!h-44"
            image={isImage}
