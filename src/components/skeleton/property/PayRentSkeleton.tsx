...
const PayRentSkeleton = () => {
  return (
    <div className="w-full flex justify-center">
      <div className="w-full grid grid-cols-12 gap-6 mt-4  items-center px-4">
        {[...Array(8)]?.map((item) => (
          <div className="w-full flex col-span-12 gap-6">
            <Skeleton
              variant="text"
              width="10%"
              height={40}
...
export default PayRentSkeleton;
